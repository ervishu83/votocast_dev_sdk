...
/**
 * Created by Chirag on 4/27/2016.
 */
public class HomeLeaderboardBaseAdapter extends BaseAdapter {

    ArrayList<LeaderBoard> datalist;
    Context context;

    public HomeLeaderboardBaseAdapter(Context context, ArrayList<LeaderBoard> datalist) {
...
//        Log.i("leader board", datalist.get(position).getCampId() + "=" + datalist.get(position).getId());


//        if (!datalist.get(position).getCampId().equals(String.valueOf(datalist.get(position).getId()))) {
//            Log.i("userID", datalist.get(position).getCampId() + "--" + datalist.get(position).getId());
//            linkHashtag.setClickListener(new Link.OnClickListener() {
//                @Override
//                public void onClick(String text) {
//                    CampaignFragment fragment = new CampaignFragment();
//                    Bundle b1 = new Bundle();
//                    b1.putString("campId", datalist.get(position).getCampId());
////                    b1.putString("from", "camp");
...
////                    Bundle b1 = new Bundle();
////                    b1.putString("user_id", String.valueOf(datalist.get(position).getId()));
////                    b1.putString("from", "home");
////
////                    fragment.setArguments(b1);
////                    FragmentManager fm = ((FragmentActivity) context).getSupportFragmentManager();
////                    FragmentTransaction ft = fm.beginTransaction();
...
//        Log.i("camp desc",datalist.get(position).getDesc());
...
//                ft.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        ...
        holder.rlVideoClickLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                b1.putString("list_type","campaign");
