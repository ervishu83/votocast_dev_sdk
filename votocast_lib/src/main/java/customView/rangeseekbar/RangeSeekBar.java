...
public class RangeSeekBar<T extends Number> extends ImageView {
     ...
     */
    public final int ACTIVE_COLOR = Color.parseColor(Constant.colorPrimary);
    ...
    private String mainMinText,mainMaxText;
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.btn_circle;
        int thumbPressed = R.drawable.btn_circle;
        int thumbDisabled = R.drawable.btn_circle;
        ...
        if (attrs == null) {
            ...
            mAlwaysActive = false;
//            mShowTextAboveThumbs = false;
            mShowTextAboveThumbs = true;
            mTextAboveThumbsColor = getResources().getColor(R.color.whiteText);
//            mTextAboveThumbsColor = Color.WHITE;
            ...
            try {
                ...
                mTextAboveThumbsColor = a.getColor(R.styleable.RangeSeekBar_textAboveThumbsColor, getResources().getColor(R.color.whiteText));
...
//        mTextSize = PixelUtil.dpToPx(context, 500);
     ...
     * that the center of the shadow is at the rank10 left corner (0,0) of the canvas. The
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        if (mShowLabels) {
            ...
            String minLabel = "00:00";

            String maxLabel = String.format("%02d:%02d",
                    getMinute(Long.parseLong(mainMaxText)),
                    getSeconds(Long.parseLong(mainMaxText)));
...
//                getSelectedMaxValue().equals(getAbsoluteMaxValue()));
        ...
        if (mShowTextAboveThumbs && (mActivateOnDefaultValues || !selectedValuesAreDefault)) {
            ...
            String min1 = String.valueOf(getSelectedMinValue());
            String max1 = String.valueOf(getSelectedMaxValue());

//            String minText = String.valueOf(getMinute(Long.parseLong(min1)) + ":" + getSeconds(Long.parseLong(min1)));
//            String maxText = String.valueOf(getMinute(Long.parseLong(max1)) + ":" + getSeconds(Long.parseLong(max1)));
//            String minText = Integer.parseInt(min1)/60 + ":" + Integer.parseInt(min1) % 60;
//            String maxText = Integer.parseInt(max1)/60 + ":" + Integer.parseInt(max1) % 60;

            String minText = String.format("%02d:%02d",
                    getMinute(Long.parseLong(min1)),
                    getSeconds(Long.parseLong(min1)));

            String maxText = String.format("%02d:%02d",
                    getMinute(Long.parseLong(max1)),
                    getSeconds(Long.parseLong(max1)));
...
//            String maxText = String.valueOf(getSelectedMaxValue());
    ...
    private Thumb evalPressedThumb(float touchX) {
        ...
        if (minThumbPressed && maxThumbPressed) {
            // if both thumbs are pressed (they lie on rank10 of each other), choose the one with more room to drag. this avoids "stalling" the thumbs in a corner, not being able to drag them apart anymore.
    ...
    public void setMaxLabel(long mainDuration) {
        mainMinText = String.valueOf(0d);
        mainMaxText = String.valueOf(mainDuration);
    }
